...
public class SetUpDevices {
	...
	public AndroidDriver<AndroidElement> setUpConnection(String udid, String deviceName) {
		...
		try {
			driver = new AndroidDriver<AndroidElement>(new URL(localURL), capabilities);
